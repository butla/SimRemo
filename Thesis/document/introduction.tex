...
Zdalne metody powinny być polimorficzne. Chodzi tu zarówno o przeładowywanie (overloading, ad-hoc polymorphism, krótkie wyjasnienie) jak i inclusion polymorphism ich argumentów (i zwracanych wartości) \cite{polymorphism}.
