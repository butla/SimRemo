...
\subsection{Android}
%moze dodac odniesienie do kilku rozdzialow learning-android od razu przy tym rozdziale, a nie gdzies w tekscie? tak się robi?
...
YAML -- ma też coś poprawiać, używa go Ansible. Whitespace sensitive, czytelny dla człowieka.\\
...
Popularne, szczególnie w dużych firmach. Dużo automatyzacji i dużo skomplikowania (dlatego te duże firmy). Ale popularne i znane.
