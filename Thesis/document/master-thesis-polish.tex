...
%Wywalić Jacka jako konsultanta. Załatwić sobie kogoś od web service’ów z KASKU jako konsultanta/recenzenta. Zmienić tytuł pracy na jakiś uniwersalny obiektowy cross-platform system. Albo coś zaznaczającego obiektowość lub polimorfizm.
%Moża podziękowania dla Lebiedzia i katedry za cierpliwość?

\include{introduction}

\include{solution-search}
