...
\end{figure}
Możliwości tego oprogramowania to:
\begin{itemize}
	\item serwowanie JSON-RPC na Androidzie;
	\item dynamiczne tworzenie obiektów klienckich JSON-RPC z~poziomu .NET;
...
Dokładniejsza struktura przygotowanych biblioteki .NET przedstawiona jest na diagramie\ref{fig:dot-net-classes}. W~przypadku Androida jest to jedna zmodyfikowana klasa jsonrpc4j (JsonRpcBasicServer). A~wspólne działanie klas na diagramie blublu. 
\begin{figure}
	\centering
