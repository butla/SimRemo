	...
	\centering
		\begin{tabular}{ | c | c | c | c | }
			\hline
				...
				\hline
		\end{tabular}
	\caption[Spełnienie wymagań systemowych.]{Spełnienie wymagań systemowych. ,,+'' oznacza, że wymaganie spełnione; ,,+\textasciitilde'', że zostało spełnione ale wymaga komentarza; ,,--'' że nie zostało spełnione.}
...
Struktura tego, co zostało zaimplementowane przedstawiona jest na schemacie BLABLABLA. Faktycznie to, co się udało to:
\begin{itemize}
