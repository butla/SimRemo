...
\begin{description}
\itemtitle{Klasyfikacja}
Pełna architektura RPC z~klientami, serwerami i~serializacją przesyłanych danych. Umożliwia generację kodu w~wielu językach. Otwarty kod. 

\itemtitle{Docelowa platforma(TODO)}
Wiele (WYMIENIĆ)
...
A może jest? Bo chyba tylko interfejsy się faktycznie generuje, a implementacje się pisze samemu i można je podmieniać za kulisami. Chyba.
...
\itemtitle{Polimorfizm metod(TODO)}


\itemtitle{Polimorfizm danych(TODO)}

\itemtitle{Tłumaczenie kodu(TODO)}
Ze wspólnego opisu generuje się kod do wielu języków.
