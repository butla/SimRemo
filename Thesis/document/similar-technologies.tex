...
Klient RPC, Serwer PRC, Serializacja
...
Niby jest, ale jak chcemy używać z polimorfizmem to druga strona musi tak samo kodować typy jak nasza konfiguracja Jacksona.
...
Wszystko super. Sam standard JSON-RPC powinien zapewniać zgodność elementów z~różnych technologii. Niestety sam standard nie jest przemyślany pod kątem polimorfizmu. W tym przypadku może działać dzięki Jacksonowi.
...
Może zrobię forka i~dopasuję do Androida. Wtedy jest to mój faworyt na wykorzystanie.
