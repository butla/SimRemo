	  ...
	  \caption[Kryteria oceny technologii.]{Kryteria oceny technologii.}
		\begin{tabular}{ | c | c | p{8cm} |}
			\hline
				...
				\hline
				Łatwość instalacji & Ogólna & Na ile intuicyjne i~mało czasochłonne jest zainstalowane danego narzędzia/biblioteki? Na ile łatwo można je/ją użyć, żeby zweryfikować, że działa?  Wyznacznik użyteczności.\\
				\hline
				...
				\hline
				Zgodność & Ogólna & Z~jakimi technologiami dany projekt może współpracować? Na jakich zasadach? Jeśli projekt jest klientem/serwerem RPC to z~jakimi klientami/serwerami może działać? Jak (czy w~ogóle?) to się zmienia po wymuszeniu polimorfizmu? \\
				\hline
